...
fn main() {
    ...
    compare_benches(vanilla_append_1000, sledgehammer_append_1000, "vanillajs");
    ...
    compare_benches(vanilla_append_10000, sledgehammer_append_10000, "vanillajs");
    ...
    compare_benches(wasm_bindgen_add, sledgehammer_add, "wasm-bindgen");
    compare_benches(vanilla_add, sledgehammer_add, "vanillajs");
    ...
    compare_benches(wasm_bindgen_swap, sledgehammer_swap, "wasm-bindgen");
    compare_benches(vanilla_swap, sledgehammer_swap, "vanillajs");
    ...
    compare_benches(wasm_bindgen_update, sledgehammer_update, "wasm-bindgen");
    compare_benches(vanilla_update, sledgehammer_update, "vanillajs");
    ...
    compare_benches(wasm_bindgen_select, sledgehammer_select, "wasm-bindgen");
    compare_benches(vanilla_select, sledgehammer_select, "vanillajs");
    ...
    compare_benches(wasm_bindgen_remove, sledgehammer_remove, "wasm-bindgen");
    compare_benches(vanilla_remove, sledgehammer_remove, "vanillajs");
}

fn compare_benches(wb: f64, sl: f64, alt: &'static str) {
    let precent_time = (sl / wb) * 100.0;
    if precent_time > 100.0 {
        console::log_2(
            &format!(
                "%csledgehammer takes {:.1}% of the time of {}",
                precent_time, alt,
            )
            .into(),
            &SLOWER_STYLE.into(),
